<form method="post" id="formSendMail" action="src/sendMail.php" class="z-10 hidden" >
    <div class="max-w-sm rounded overflow-hidden shadow-lg bg-gray-200">
        ...
        <input class="ml-5 bg-blue-100 hover:bg-blue-300 rounded-sm my-2" type="reset" value="Reset">
        <input class="rounded-sm inset-y-0 bg-blue-100 hover:bg-blue-300 float-right mr-5 my-2" type="submit" value="Send" />
    </div>
</form>
