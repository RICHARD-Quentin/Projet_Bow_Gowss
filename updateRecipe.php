        ...
        <div class="mx-auto border-gray-500 w-2/3 flex-col shadow-lg my-6 rounded">
            <div class="w-full inline-block mx-auto">
                ...
                <div  class="mb-2">
                    ...
                    <textarea name="content" class="w-1/2 border rounded border-gray-500" ><?php echo $cont['title']; ?></textarea>
                </div>
            </div>
            ...
            <div id="ing" class="w-full inline-block text-center mb-5">
                ...
                <ul id="ingredientList" class="mb-2">
                    <?php foreach ($ingredients as $ingredient){ ?>
                        <li id="" class="ingredient relative list-none flex-row">
            ...
            <div class="inline-block w-1/3">
                <label for="">Qté</label>
                <input type="text" value=' ' class="qte border border-gray-500" value="" name="qte[]">

                <select class=" unit border border-gray-500" name="unit[]" value="">
...
<script>
    ...
    $('#addIngredientButton').click(function(e){
        var $clone=`<li id="newIngredient" class="newIngredient relative list-none flex-row">
            <div class="inline-block w-1/3">
                <label>Ingredient :</label>
    ...
    $('#addStepButton').click(function(){
        var $clone=
            `<li id="newStep" class="newStep relative list-none">
            <div>
